...
while ($row = mysqli_fetch_array($sql)) {
    $html .= "<li onclick=\"mostrar('".$row["cliente"]."')\" style='background-color: #6f7cf6; border: 1px solid rgba(59, 248, 59, 0.933); padding: 3px; width:100%; float:left; cursor:pointer;' >" . $row["cliente"] . " </li>";
}
echo json_encode($html, JSON_UNESCAPED_UNICODE);
