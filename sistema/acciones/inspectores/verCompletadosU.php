            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="padding-top: 10px;">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" style="padding-bottom: 15px;">
                        ...
                        <a href="asignaciones.php" class="btn btn-danger" style="margin-top: 8px; display: inline-block; width:100%"><i class="fa-solid fa-rotate-left"></i> Regresar</a>
                ...
                <script>
                    ...
                    function getData() {
                        ...
                        let url = "busquedaFinalizadoU.php"
