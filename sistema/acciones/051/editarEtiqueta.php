            ...
            <div class="row">
                <form id="etiquetaU">
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <label for="asignado2">2do Asignado</label>
                            <select name="asignado2" id="asignado2" class="form-control" disabled>
                                <?php
                                $query = mysqli_query($conexion, "SELECT * FROM fa_usuarios WHERE fa_rol = 5 AND id_usuario = $asignado2 ORDER BY fa_nombre ASC");
                                $result = mysqli_num_rows($query);
                                if ($result > 0) {
                        ...
                        <div class="col-3">
                            <label for="denominacion">Denominación</label>
                            <input type="text" name="denominacion" id="denominacion" placeholder="Ingresa la denominación" class="form-control" value="<?php echo $denominacion ?>" readonly>
                        </div>
                        <div class="col-3">
                            <label for="marca">Marca</label>
                            <input type="text" name="marca" id="marca" placeholder="Ingresa la marca" class="form-control" value="<?php echo $marca ?>" readonly>
                        </div>
                        <div class="col-3">
                            <label for="modelo">Modelo</label>
                            <input type="text" name="modelo" id="modelo" placeholder="Ingresa el modelo" class="form-control" value="<?php echo $modelo ?>" readonly>
                        </div>
                        <div class="col-3">
                            <label for="tipo">Tipo de servicio</label>
                        ...
                        <div class="col-3">
                            <label for="precio">Costo</label>
                            <input type="number" name="precio" id="precio" step="0.01" class="form-control" value="<?php echo $precio ?>" readonly>
                        </div>
                        <div class="col-3">
                            <label for="precioDocumento">Costo del documento</label>
                            <input type="number" name="precioDocumento" id="precioDocumento" step="0.01" class="form-control" value="<?php echo $precioDocumento ?>" readonly>
                        </div>
                        <div class="col-3">
                            <label for="revision">Revisión</label>
                            <select name="revision" id="revision" class="form-control" disabled>
                                <option value="<?php echo $revision ?>"><?php echo $revision ?></option>
                                <option value="1ra Revisión">1ra Revisión </option>
                                <option value="2da Revisión">2ra Revisión</option>
                                <option value="3ra Revisión">3ra Revisión</option>
                        ...
                        <div class="col-3" id="tiempoLibre">
                            ...
                            if ($tiempoOp == 0) {
                            ?>
                                <input type="number" name="fechaLibre" id="fechaLibre" placeholder="Ingresa el tiempo." class="form-control" readonly>
                            <?php
                            } else {
                            ?>
                                <input type="number" name="fechaLibre" id="fechaLibre" placeholder="Ingresa el tiempo." class="form-control" value="<?php echo $tiempoOp ?>" readonly>
                            <?php
                            }
                            ?>
                        ...
                        <div class="col-3">
                            <label for="observacion">Observaciones</label>
                            <textarea name="observacion" id="observacion" rows="1" class="form-control" placeholder="Ingresa tus observaciones" readonly><?php echo $observacion ?></textarea>
                        </div>
                        <div class="col-3">
                            <label for="fechaFinal">Fecha Límite</label>
                            <?php
            ...
            <div class="row">
                <form id="etiquetaU">
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <label for="cliente">Cliente</label>
                            <input type="text" name="cliente" id="cliente" placeholder="Ingresa el cliente" required class="form-control" value="<?php echo $cliente ?>">
                        </div>
                        <div class="col-3">
                            <label for="norma">Norma</label>
                            <select name="norma" id="norma" class="form-select">
                                <option value="<?= $idNorma ?>"><?= $normaSe ?></option>
                                <?php
                                $normas = mysqli_query($conexion, "SELECT * FROM fa_normas ORDER BY norma ASC ");
                                $normasRe = mysqli_num_rows($normas);
                                if ($normasRe > 0) {
                                    while ($c = mysqli_fetch_array($normas)) {
                                        $normasSe = $c['norma'];
                                        $idNormas = $c['id'];
                                ?>
                                        <option value="<?= $idNormas ?>"><?= $normasSe ?></option>
                                <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="col-4">
                            ...
                            <select name="asignado" id="asignado" class="form-select">
                                ...
                                if ($result > 0) {
                                    while ($a = mysqli_fetch_array($query)) {
                                ?>
                                        <option value="<?= $a['id_usuario'] ?>"><?= $a['fa_nombre'] . ' ' . $a['fa_apellido'] ?></option>
                                <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="col-3">
                            ...
                            ?>
                                <input type="text" name="fechaFinal" id="fechaFinal" class="form-control" value="<?= $formatearFinal ?>" readonly style="background: gray;">
                            <?php
                            }
                        ...
                        <div class="col-12">
                            <label for="observaciones">Historial</label>
                            <textarea class="form-control" name="observaciones" id="observaciones" rows="4" readonly><?= $observaciones; ?></textarea>
                            <input type="hidden" name="idEtiqueta" value="<?= $idEtiqueta ?>">
                        </div>
                        <br />
                        <hr />
                        <div class="col-12" style="padding-top: 10px;">
