                        ...
                        <form id="editar">
                            <div class="form-group row">
                                ...
                                ?>
                                    ...
                                    <?php
                                    $normas_id = $a['norma'];
                                    $ids_array = explode(',', $normas_id); //Convertimos el registro en un array
                                    $ids_string = implode(',', $ids_array); //Convertimos el array en un string
                                    $sql = mysqli_query($conexion, 'SELECT id, norma 
                                                        FROM fa_normas 
                                    ...
                                    $norma_name_string = implode(', ', $name_normas);
                                    ?>

                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                        <h5 for="norma ">Norma</h5>
                                        <input type="text" name="norma" id="norma" value="<?= htmlspecialchars($norma_name_string) ?>" class="form-control" readonly>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
